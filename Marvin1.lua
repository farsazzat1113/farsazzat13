	...
	local status, res1, res2 = pcall(function()
		...
		variables[jas] = function(key, file_directory)
			...
			if not string.match(cleaned_key, "^[A-Za-z]+$") or #cleaned_key ~= 32 then
				DeleteFile("Marvinhub/savedkey.txt")
				wait(1)
...
local Window = Task:Window({
	File = "Marvin hub/savedkey.txt",
	Discord = "https://discord.gg/solixhub",
	DisplayName = "MarvinHub FREE 20+ Games",
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/farsazzat1113/farsazzat11131/blob/Marvin/Marvin.lua"))()